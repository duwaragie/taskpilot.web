...
const Toast: React.FC<ToastProps> = ({ toast }) => {
  ...
  return (
    <div className={`flex items-start p-4 rounded-lg border shadow-lg transition-all duration-300 ${getToastStyles(toast.type)} animate-slide-up`}>
      ...
      <div className="flex-1">
        ...
        {toast.action && (
          <button
            ...
            className="mt-2 px-3 py-1 text-xs font-medium bg-white bg-opacity-20 hover:bg-opacity-30 rounded-md transition-colors"
          >
            {toast.action.label}
          </button>
        )}
